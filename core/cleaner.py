        ...
        if isinstance(facts, list):
            for item in facts:
                if isinstance(item, dict):
                    ...
                    if fact_type:
                        df[fact_type] = fact_value # Ajoute une colonne pour chaque type de fait
